...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // sort by mention volume, but push 'overall' to bottom — it's not actionable
    const buzz = PARAMS
      ...
      .sort((a, b) => {
        // push 'overall' to bottom — not actionable for product decisions
        if (a.parameter === 'overall') return 1;
        if (b.parameter === 'overall') return -1;
